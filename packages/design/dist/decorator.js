...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/decorator/example.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../../../usr/local/lib/node_modules/webpack/node_modules/process/browser.js */ "../../../../usr/local/lib/node_modules/webpack/node_modules/process/browser.js"), __webpack_require__(/*! ./../../../../../../usr/local/lib/node_modules/webpack/buildin/global.js */ "../../../../usr/local/lib/node_modules/webpack/buildin/global.js")))

/***/ }),

/***/ "./src/decorator/example.ts":
/*!**********************************!*\
  !*** ./src/decorator/example.ts ***!
  \**********************************/
/*! no exports provided */
...
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./service */ "./src/decorator/service.ts");
...
function dvalue(target, propertyName) {
  // prototype.name = 'Nealayng';
  target[propertyName] = 'Nealayng';
}

function dmethod(target, propertyName, descriptor) {
  var method = descriptor.value;

  descriptor.value = function () {
    var ret = method.call(this);
    console.log(ret);
  };
} // 参数修饰器


function dparam(target, name, index) {
  var method = target[name];
  Reflect.defineMetadata('test', '记录参数', method);
}

var MyAction = dclass(_class = (_class2 = (_temp = /*#__PURE__*/function () {
  ...
  dparam(MyAction.prototype, "setPath", 0);
  return MyAction;
}(), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "name", [dvalue], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _applyDecoratedDescriptor(_class2.prototype, "getPath", [dmethod], Object.getOwnPropertyDescriptor(_class2.prototype, "getPath"), _class2.prototype)), _class2)) || _class;

var action = new MyAction();
action.setPath(''); // 元数据

Reflect.defineMetadata('test', 'a', MyAction); // console.log(Reflect.getMetadata('test', MyAction));
// console.log(Reflect.getMetadata('test', action.setPath));
// 执行 inversify

console.log(_service__WEBPACK_IMPORTED_MODULE_1__["default"].get('runtime'));
console.log(_service__WEBPACK_IMPORTED_MODULE_1__["default"].getNamed('docker', 'jd'));

/***/ }),

/***/ "./src/decorator/service.ts":
/*!**********************************!*\
  !*** ./src/decorator/service.ts ***!
  \**********************************/
...
var _dec, _class, _dec2, _class2, _temp, _dec3, _class4, _temp2, _dec4, _class6, _temp3;
 ...
 * @file 实现
 */
var Slam = (_dec = Object(inversify__WEBPACK_IMPORTED_MODULE_0__["injectable"])(), _dec(_class = /*#__PURE__*/function () {
  function Slam() {
    _classCallCheck(this, Slam);
  }
...
var Borg = (_dec2 = Object(inversify__WEBPACK_IMPORTED_MODULE_0__["injectable"])(), _dec2(_class2 = (_temp = // 注入一个构造器
function Borg(Class) {
  _classCallCheck(this, Borg);

  this.type = 'borg';
  this.count = void 0;
  this.count = new Class();
}, _temp)) || _class2);
Borg = Object(inversify__WEBPACK_IMPORTED_MODULE_0__["inject"])('Newable<c>')(Borg, undefined, 0) || Borg;
var Docker = (_dec3 = Object(inversify__WEBPACK_IMPORTED_MODULE_0__["injectable"])(), _dec3(_class4 = (_temp2 = // 动态工厂
function Docker(factory) {
...
Docker = Object(inversify__WEBPACK_IMPORTED_MODULE_0__["inject"])('Factory<f>')(Docker, undefined, 0) || Docker;
var Runtime = (_dec4 = Object(inversify__WEBPACK_IMPORTED_MODULE_0__["injectable"])(), _dec4(_class6 = (_temp3 = function Runtime(slam) {
  _classCallCheck(this, Runtime);

  this.times = void 0;
  console.log(slam.trace());
}, _temp3)) || _class6); // 每次都创建新的 实例

Runtime = Object(inversify__WEBPACK_IMPORTED_MODULE_0__["inject"])('slam')(Runtime, undefined, 0) || Runtime;
var myContainer = new inversify__WEBPACK_IMPORTED_MODULE_0__["Container"]({
  defaultScope: 'Transient'
}); // 可以在绑定时重新指定 scope

myContainer.bind('slam').to(Slam).inSingletonScope();
myContainer.bind('runtime').to(Runtime); // 通过 name 区分同一接口的不同实现

myContainer.bind('docker').to(Docker).whenTargetNamed('jd');
myContainer.bind('docker').to(Borg).whenTargetNamed('bd'); // 绑定构造器

myContainer.bind('Newable<c>').toConstructor(Slam); // 绑定工厂函数，然后根据参数创建不同的对象，这里又可以进一步提升程序的灵活性

myContainer.bind('Factory<f>').toFactory(function () {
  return function () {
    return 111111;
  };
}); // 所有实例都由 container 管理
