...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/dva/app.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
app.add({
    ...
    reducers: {
        add: function (state) {
            ...
            return __assign({}, state, { record: newCurrent > state.record ? newCurrent : state.record, current: newCurrent });
        }
    }
});
exports.default = {
...
function initDom(models) {
    return (React.createElement("main", null, models.map(function (model) { return React.createElement(model.component, { key: Date.now() }); })));
}
var Polymer = /** @class */ (function () {
    function Polymer() {
        this.models = [];
    }
    Polymer.prototype.add = function (model) {
    ...
    Polymer.prototype.start = function (el) {
        ...
        var childrens = initDom(this.models);
        ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store }, childrens), el);
    };
    return Polymer;
}());
