...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/redux/app.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
var provider_1 = __webpack_require__(/*! ./provider */ "./src/redux/provider.tsx");
var header_1 = __webpack_require__(/*! ./header */ "./src/redux/header.tsx");
var main_1 = __webpack_require__(/*! ./main */ "./src/redux/main.tsx");
var store_1 = __webpack_require__(/*! ./store */ "./src/redux/store.ts");
 ...
 * @file redux connext
 */
var connect = function (mapStateToProps, mapDispatchToProps) { return function (WrappedComponent) {
    var _a;
    return _a = /** @class */ (function (_super) {
             ...
             */
            Wrap.prototype.update = function (data, staticProps) {
                var props = mapStateToProps(data);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
var connect_1 = __webpack_require__(/*! ./connect */ "./src/redux/connect.tsx");
...
function stateChanger(state, action) {
    switch (action.type) {
        case 'UPDATE_HEADER_TEXT':
            return __assign({}, state, { header: __assign({}, state.header, { text: action.text }) });
        case 'UPDATE_HEADER_COLOR':
            return __assign({}, state, { header: __assign({}, state.header, { color: action.color }) });
        case 'UPDATE_CONTENT_TEXT':
            return __assign({}, state, { content: __assign({}, state.content, { text: action.text }) });
    }
}
var appState = {
    header: {
