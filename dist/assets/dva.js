 ...
 */
var app = dva__WEBPACK_IMPORTED_MODULE_1___default()({ history: history_createBrowserHistory__WEBPACK_IMPORTED_MODULE_3___default()() });
app.model({
    namespace: 'count',
    state: {
        record: 0,
    ...
    reducers: {
        add: function (state) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { record: newCurrent > state.record ? newCurrent : state.record, current: newCurrent });
        }
    }
});
...
var CountApp = function (_a) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_2__["createElement"]("div", null,
        ...
        react__WEBPACK_IMPORTED_MODULE_2__["createElement"]("div", null,
            ...
            count.current),
        react__WEBPACK_IMPORTED_MODULE_2__["createElement"]("div", null,
            react__WEBPACK_IMPORTED_MODULE_2__["createElement"]("button", { onClick: function () {
                    dispatch({ type: 'count/add' });
                } }, "+"))));
};
var HomePage = Object(dva__WEBPACK_IMPORTED_MODULE_1__["connect"])(mapStateToProps)(CountApp);
app.router(function () { return react__WEBPACK_IMPORTED_MODULE_2__["createElement"](HomePage, null); });
app.start('#app');
